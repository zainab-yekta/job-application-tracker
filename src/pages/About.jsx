  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '800px', margin: 'auto', textAlign: 'center' }}>
      ...
      <p>
        ...
        place. Stay organized with features like interview reminders, application analytics, growth
        trends, and more.
      </p>

      <p>Your data stays in your own browser. Nothing is sent to a server.</p>
      ...
      <p>
        ...
        {' · '}
        <a href="https://linkedin.com/in/zeinab-ramezani" target="_blank" rel="noopener noreferrer">
          LinkedIn
        </a>
      </p>
    </div>
